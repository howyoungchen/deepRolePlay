...
2. **⚙️ Modify Configuration File**
   ...
   # Agent Configuration - Background agent (Recommended Qwen3-235B)
   agent:
     model: "qwen/qwen3-235b-a22b-2507"                # Recommended model
     base_url: "https://openrouter.ai/api/v1"          # OpenRouter address
     api_key: "Your-OpenRouter-API-Key"                # Change to your OpenRouter key
   ```
...
4. **🔗 Configure Role-Playing Frontend**
   ...
   - API Key can be any value (system will automatically use the key from config file)
