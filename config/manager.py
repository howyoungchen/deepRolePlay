...
class ProxyConfig(BaseModel):
    ...
    save_full_messages: bool = False  # Whether to save complete request messages
...
class LangGraphConfig(BaseModel):
    ...
    last_ai_messages_index: int = 1  # Index of the AI message to use as real response (1 = last, 2 = second-to-last, etc.). Set to -1 for auto-detection of first AI message with content > 100 chars from tail.
